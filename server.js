...
var server = http.createServer(function (request, response) {
  ...
  if (path === "/index.html") {
    ...
    response.statusCode = 200;
    response.setHeader("Content-Type", "text/javascript;character = utf-8");
    ...
    response.statusCode = 200;
    response.setHeader("Content-Type", "text/xml;character = utf-8");
    response.write(fs.readFileSync("public/4.xml"));
    response.end();
  } else if (path === "/5.json") {
    response.statusCode = 200;
    response.setHeader("Content-Type", "text/json;character = utf-8");
